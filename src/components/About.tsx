      ...
      <div className="container-elegant">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 animate-slideInLeft">
            <div>
              <p className="font-sans text-sm font-semibold text-slate-500 tracking-widest uppercase mb-4">
                About UKUKEE
              </p>
            ...
            <p className="text-elegant text-slate-700/75">
          ...
          <div className="relative h-96 md:h-full min-h-96 group">
            ...
            <div className="absolute inset-4 border-2 border-slate-200 rounded-lg hover-lift"></div>
