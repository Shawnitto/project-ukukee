...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="section-padding bg-gradient-to-b from-cream via-amber/5 to-cream">
      <div className="container-elegant">
        ...
        {/* Category Filter */}
        <div className="flex flex-wrap justify-center gap-4 mb-12 pb-12 border-b border-terra/10">
          ...
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              <div className="space-y-5">
                {/* Image Placeholder */}
                <div className="relative h-80 overflow-hidden bg-gradient-to-br from-cream to-amber/10 rounded-lg hover-lift">
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="text-center">
                      <div className="font-serif text-5xl text-amber/20 mb-2">◆</div>
                      <p className="text-terra/30 font-sans text-sm">{item.category}</p>
                    </div>
                  </div>
                  
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-terra/0 group-hover:bg-terra/5 transition-colors duration-500 flex items-center justify-center">
                    <p className="text-terra/0 group-hover:text-terra/70 font-sans font-medium transition-all duration-300 text-sm">
                      View Project
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <p className="text-xs font-sans font-semibold text-gold uppercase tracking-wider">{item.category} • {item.year}</p>
                  <h3 className="font-serif text-xl text-terra group-hover:text-amber transition-colors duration-300">
                    {item.title}
                  </h3>
                  <p className="text-sm text-terra/65 leading-relaxed">
                    {item.description}
                  </p>
                </div>
              </div>
